...
const TRANSLATIONS = {
    pl: {
        ...
        aiNoKey: 'Najpierw skonfiguruj połączenie AI w ustawieniach.',
        ...
        // AI connections (provider config)
        aiConnections: 'Połączenia AI',
        aiNoConnection: 'Brak połączeń AI. Dodaj pierwsze połączenie poniżej.',
        aiAddConnection: 'Dodaj połączenie',
        aiEditConnection: 'Edycja połączenia',
        aiConnectionName: 'Nazwa połączenia',
        aiConnectionNameRequired: 'Podaj nazwę połączenia.',
        aiBaseURLLabel: 'URL API',
        aiModelLabel: 'Model',
        aiActive: 'Aktywny',
        aiActivate: 'Aktywuj',
        aiDeleteConnection: 'Usuń połączenie',
        aiConnectionsSaved: 'Połączenie zapisane.',
        aiKeyPlaceholder: 'AIza... / sk-...',
        edit: 'Edytuj',
        aiTest: 'Testuj połączenie',
        aiTesting: 'Testowanie połączenia...',
        aiTestOk: 'Połączenie działa.',
        aiTestFailed: 'Błąd połączenia.',
        aiTestReply: 'Odpowiedź modelu',
        aiTestError: 'Błąd',
        // Infinite AI quiz
        ...
        mpPlayers: 'Gracze',
        mpStartGame: 'Start',
        mpStartMultiplayer: 'Start multiplayer',
        mpPacksName: 'Pakiety',
        mpAiInfiniteSolo: 'Nieskończony quiz AI działa tylko w trybie solo.',
        mpUploadHint: 'Pakiet startowy tworzysz na tablicy — te same pytania zagrają w multiplayerze.',
    ...
    en: {
        ...
        aiNoKey: 'Set up an AI connection in settings first.',
        ...
        aiNoConnection: 'No AI connections yet. Add your first connection below.',
        aiAddConnection: 'Add connection',
        aiEditConnection: 'Edit connection',
        aiConnectionName: 'Connection name',
        aiConnectionNameRequired: 'Provide a connection name.',
        aiBaseURLLabel: 'API URL',
        aiModelLabel: 'Model',
        aiActive: 'Active',
        aiActivate: 'Activate',
        aiDeleteConnection: 'Delete connection',
        aiConnectionsSaved: 'Connection saved.',
        aiKeyPlaceholder: 'AIza... / sk-...',
        edit: 'Edit',
        ...
        mpStartMultiplayer: 'Start multiplayer',
        mpPacksName: 'Packs',
        mpAiInfiniteSolo: 'The Infinite AI Quiz works in solo mode only.',
        mpUploadHint: 'Build your starting pack on the dashboard — the same questions will be played in multiplayer.',
